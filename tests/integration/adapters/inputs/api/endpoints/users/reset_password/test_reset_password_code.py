...
async def test_should_handle_domain_exception(
    ...
    # arrange
    use_case_override_with_error(reset_password_code_factory, InactiveUserError())
...
async def test_should_handle_application_exception(
    ...
    # arrange
    use_case_override_with_error(reset_password_code_factory, EmailAlreadyUsedError())
