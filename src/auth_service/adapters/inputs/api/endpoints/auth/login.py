...
from auth_service.adapters.inputs.api.dependencies.use_cases import LoginDep
...
async def login(
    ...
    return TokensBodyResponse(access=tokens.access.token, refresh=tokens.refresh.token)
