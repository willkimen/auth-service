...
from auth_service.domain.utils import ensure_aware, ensure_not_none
...
class User:
    ...
    def __init__(
        ...
        self._email_verified: bool = User._validate_email_verified(email_verified)
    ...
    def _validate_not_before_created_at(self, date: datetime, field: str) -> datetime:
