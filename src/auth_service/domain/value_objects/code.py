...
from auth_service.domain.exceptions import CodeErrorCode, InvalidCodeError
...
class Code:
    ...
    def generate(cls) -> Code:
        value = ''.join(secrets.choice('0123456789') for _ in range(cls._LENGTH))
        return cls(value)
    ...
    def _validate(self, value: str) -> str:
        ...
        if not isinstance(value, str):
            raise TypeError(f'Invalid code: expected str, got {type(value).__name__}')
