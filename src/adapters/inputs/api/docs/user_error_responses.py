...
from adapters.inputs.api.docs.application_error_examples import (
...
from adapters.inputs.api.docs.domain_error_examples import (
...
from adapters.inputs.api.docs.helpers import INTERNAL_SERVER_ERROR_RESPONSE
...
change_email_code_responses = {
    ...
    status.HTTP_401_UNAUTHORIZED: {
        'model': ErrorResponse,
        'description': (
            'The access token is invalid or authentication failed.'
        ),
        'content': {
            'application/json': {
                'examples': {
...
change_email_responses = {
    ...
    status.HTTP_404_NOT_FOUND: {
        'model': ErrorResponse,
        'description': (
            'The requested user or verification code was not found.'
        ),
        'content': {
            'application/json': {
                'examples': {
...
change_password_responses = {
    ...
    status.HTTP_404_NOT_FOUND: {
        'model': ErrorResponse,
        'description': (
            'The authenticated user or verification code was not found.'
        ),
        'content': {
            'application/json': {
                'examples': {
...
delete_account_code_responses = {
    status.HTTP_400_BAD_REQUEST: {
        'model': ErrorResponse,
        'description': (
            'The provided token type is invalid for this operation.'
        ),
        'content': {
            'application/json': {
                'examples': {
...
delete_account_responses = {
    status.HTTP_400_BAD_REQUEST: {
        'model': ErrorResponse,
        'description': (
            'The request contains an invalid token type or '
...
email_verification_responses = {
    status.HTTP_400_BAD_REQUEST: {
        'model': ErrorResponse,
        'description': (
            'The verification code type is invalid for this operation.'
        ),
        'content': {
            'application/json': {
                'examples': {
...
reset_password_responses = {
    ...
    status.HTTP_403_FORBIDDEN: {
        'model': ErrorResponse,
        'description': (
            'The user account cannot reset the password because '
            'it is inactive.'
        ),
        'content': {
            'application/json': {
